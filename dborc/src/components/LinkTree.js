...
const LinkTree = (props) => {
    ...
    return (
        <div className="z-10 flex flex-col relative h-[calc(100vh-150px)] max-w-[400px] mx-auto my-[50px] px-5">
            <a href="/DylanBorchertResume.pdf" download id="download" hidden></a>
            <div>
                <p className="text-lg text-white text-center font-semibold">Contact:</p>
            </div>
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#179287] transition duration-150 ease-out hover:ease-in shadow-md flex">
                <a href="https://drive.google.com/file/d/1BWBM5e5onHtV0kcmTuHcpM6hlUk0eWEN/view?usp=sharing" target="_blank" className="w-full flex align-middle">
                <svg 
                    className="w-8 h-8 fill-current"
                    xmlns="http://www.w3.org/2000/svg" 
                    role="img" viewBox="0 0 24 24">
                    <g fill="currentColor"><path fill-rule="evenodd" d="M17 5H7a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1ZM7 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3H7Z" clip-rule="evenodd"/><path d="M8 7h8v2H8V7Zm0 4h8v2H8v-2Zm0 4h5v2H8v-2Z"/></g>
                    </svg>
                    <div className="flex justify-between w-full">
                        <p className="pl-3 text-md font-semibold my-auto text-lg">
                            Resume 
                        </p>
                        <p className="text-sm px-1 text-gray-500 text-md font-semibold my-auto group-hover:text-black">Resume</p>
                    </div>
                </a>
                <svg
                    onClick={downloadResume}
                    className="w-8 h-8 fill-current my-auto text-gray-800 hover:text-gray-200 transition duration-150 ease-out hover:ease-in rounded-md p-1 ml-2 hover:bg-gray-500 border border-spacing-3 border-gray-800 hover:cursor-pointer hover:shadow-md"
            ...
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#EA4335] transition duration-150 ease-out hover:ease-in shadow-md flex">
                <a href="mailto: dborc610@mtroyal.ca" target="_blank" className="w-full flex align-middle">
                <svg 
                    className="w-8 h-8 fill-current"
                    xmlns="http://www.w3.org/2000/svg" 
                    role="img" viewBox="0 0 36 36">
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <p className="text-sm px-1 text-gray-500 text-md font-semibold my-auto group-hover:text-black">dborc610@mtroyal.ca</p>
                    </div>
                </a>
                <svg
            ...
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#0A66C2] transition duration-150 ease-out hover:ease-in shadow-md">
                <a href="https://www.linkedin.com/in/dylan-borchert/" target="_blank" className="w-full flex align-middle">
                    <svg 
                        className="w-8 h-8 fill-current"
                        role="img" viewBox="0 0 24 24" 
                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <p className="text-sm px-1 text-gray-500 text-md font-semibold my-auto group-hover:text-black">dylan-borchert</p>
                    </div>
                </a>
            </div>
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#3ee15a] transition duration-150 ease-out hover:ease-in shadow-md hidden">
                <a href="tel:+14034723303" target="_blank" className="w-full flex align-middle">
                <svg 
                    className="w-8 h-8 fill-current"
                    xmlns="http://www.w3.org/2000/svg" 
                    role="img" viewBox="0 0 12 12">
                    <path fill="currentColor" d="m5.966 4.49l-.827.742a4.914 4.914 0 0 0 .455 1.073a4.736 4.736 0 0 0 .722.922l1.071-.33c.6-.185 1.255.005 1.654.48l.61.726a1.47 1.47 0 0 1-.137 2.042c-.995.908-2.527 1.215-3.674.314a10.429 10.429 0 0 1-2.516-2.87A9.986 9.986 0 0 1 2.03 4.013c-.22-1.422.821-2.56 2.119-2.948c.774-.232 1.6.166 1.884.908l.335.875c.22.576.062 1.225-.402 1.641Z"/>
                </svg>
                    <div className="flex justify-between w-full">
                        <p className="pl-3 text-md font-semibold my-auto text-lg">
                            Call 
                        </p>
                        <p className="text-sm px-1 text-gray-500 text-md font-semibold my-auto group-hover:text-black">{"\(403\) 472-3303"}</p>
                    </div>
                </a>
            </div>
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#F05032] transition duration-150 ease-out hover:ease-in shadow-md">
                <a href="https://github.com/dborc610" target="_blank" className="w-full flex align-middle">
                <svg 
                    className="w-8 h-8 fill-current"
                    xmlns="http://www.w3.org/2000/svg"
                    role="img" viewBox="0 0 24 24" >
            ...
            <div className=" bg-white w-full p-2 my-2 rounded-lg hover:bg-gray-200 group hover:text-[#F15A2C] transition duration-150 ease-out hover:ease-in shadow-md hidden">
                ...
                <path d="M11.406 8.528h1.17v6.926h-1.17zM1.17 15.454H0V8.528h1.17zm4.534.828h1.17v2.645h-1.17zm-2.86-2.969h1.169v4.282h-1.17zm5.703 0h1.17v4.282h-1.17zM22.83 8.528H24v6.926h-1.17zm-4.534-.81h-1.17V5.073h1.17zm2.86 2.95h-1.169V6.406h1.17zm-5.72 0h-1.17V6.406h1.17z"/>
                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <p className="text-sm px-1 text-gray-500 text-md font-semibold my-auto group-hover:text-black">personal server</p>
                    </div>
                </p>
            </div>
        </div>
