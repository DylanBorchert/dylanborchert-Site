  ...
  if (!remove) {
    ...
    function save() {
      if (!buffer) {
        ...
        buffer.width = window.screen.availWidth;
        buffer.height = window.screen.availHeight;
      ...
      buffer.ctx.drawImage(
        buffer.canvas,
        Math.round(buffer.width / 2 - buffer.canvas.width / 2),
        Math.round(buffer.height / 2 - buffer.canvas.height / 2)
      );
